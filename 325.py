...
url = "https://drive.google.com/uc?id=1hykoubWsMB3RLo2ZK55K7Qz9XynZWLam"
...
fig_map = px.scatter_geo(data, lat='latitude', lon='longitude', color='magnitude', hover_name='location',
...
fig_histogram = px.histogram(data, x='magnitude', nbins=30, title='Magnitude Distribution Over Time')
st.plotly_chart(fig_histogram)

# 3D Scatter Plot
st.write("3D Scatter Plot of Earthquake Data (Depth, Magnitude, Gap)")
fig_3d_scatter = px.scatter_3d(data, x='depth', y='magnitude', z='gap', color='country',
...
fig_density_contour = px.density_contour(data, x='longitude', y='latitude', color='magnitude',
